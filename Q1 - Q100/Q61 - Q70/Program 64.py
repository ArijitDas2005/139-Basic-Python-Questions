# Q.Write a Python program to find all duplicate characters in string.
...
def find_duplicates(input_str):
    ...
    # Iterate through the dictionary and add characters with count > 1 to the duplicates list
